...
pip install -r requirements.txt
$env:SPOTIFY_CLIENT_ID="1274dd22dc0d4d25a46fe1554fc5b33e"
$env:SPOTIFY_CLIENT_SECRET="01b3d65862b04203acb19326f052718e"
...
pip install -r requirements.txt
set SPOTIFY_CLIENT_ID=1274dd22dc0d4d25a46fe1554fc5b33e
set SPOTIFY_CLIENT_SECRET=01b3d65862b04203acb19326f052718e
set SPOTIFY_REDIRECT_URI=http://localhost:3000/callback
py manage.py makemigrations
py manage.py migrate
py manage.py runserver 0.0.0.0:8000
```
...
> If PowerShell blocks script execution, run PowerShell as Administrator and execute:
