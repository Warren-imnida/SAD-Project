...
## Windows Quick Fix for venv activation
If you are on Windows PowerShell, do not use `source .venv/bin/activate`. Use `\.venv\Scripts\Activate.ps1` instead. Full Windows commands are in `docs/setup.md`.
